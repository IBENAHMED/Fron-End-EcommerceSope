      ...
      <div className='p-5'>
        ...
        {isMobile ? (
          <select onChange={handleClickOption} className='px-3 py-1 rounded text-slate-600'>
            ...
            {isMobile && role == "ADMIN" ? (
              <>
                <option className='cursor-pointer p-1 text-gray-600 hover:text-gray-900 text-xs md:text-sm'>AddProduct</option>
                <option className='cursor-pointer p-1 text-gray-600 hover:text-gray-900 text-xs md:text-sm'>ListProduct</option>
              </>
            ) : (
              <></>
            )}
