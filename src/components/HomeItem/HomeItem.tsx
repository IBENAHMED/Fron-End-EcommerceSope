            ...
            <div className="font-sans antialiased">
                ...
                <main className="text-center p-10 bg-gray-50">
                    <div className="flex flex-col items-center">
                        ...
                        <h1 className="text-4xl font-semibold text-gray-800 mb-4">The New Way To Display Product by <span className="text-green-600">Colorlib</span></h1>
                        <button className="mt-4 px-6 py-2 bg-black text-white rounded-lg hover:bg-gray-800">Explore Now</button>
                    </div>
                </main>
                ...
                <section className="flex flex-wrap justify-around items-center py-10 bg-white">
                    <div className="text-center max-w-xs m-4 p-6 bg-gray-50 rounded-lg shadow-lg">
                        ...
                        <h2 className="text-xl font-bold mb-2">Worldwide Delivery</h2>
                    ...
                    <div className="text-center max-w-xs m-4 p-6 bg-gray-50 rounded-lg shadow-lg">
                        <div className="text-4xl mb-3">🔄</div>
                        <h2 className="text-xl font-bold mb-2">Simple Returns</h2>
                        <p className="text-gray-600">Far far away, behind the word mountains, far from the countries.</p>
                    </div>
                </section>
            </div>
