  ...
  return (
    <div className='flex items-center mb-5 justify-center bg-gray-50'>
      <div className='bg-white text-center p-4 rounded-lg shadow-lg w-full max-w-md transform transition-transform duration-500 hover:scale-105 sm:p-8 mx-5 sm:text-left'>
        {state === "Sign Up" ? <h4 className='text-xs sm:text-3xl font-bold mb-6 text-center text-gray-900'>Sign Up</h4> : <h4 className='text-xs sm:text-3xl font-bold mb-6 text-center text-gray-900'>Login</h4>}
        <form>
          {state === "Sign Up" ? (
            <div className='mb-4'>
              ...
              <input
                ...
                className='w-full p-3 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-colors duration-200 text-black'
              />
            </div>
          ) : (
            <></>
          ...
          <div className='mb-4'>
            ...
            <input
              ...
              className='text-black w-full p-3 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-colors duration-200'
            />
          </div>
          <div className='mb-4'>
          ...
          <div className='mb-6'>
            <button onClick={(e: any) => (state === "Sign Up" ? SignUpUser(e) : login(e))} type='submit' className='w-full bg-blue-700 text-white py-3 px-4 rounded-lg hover:bg-blue-800 transition-colors duration-300'>
        ...
        <div className='text-center mt-4'>
          {state === "Sign Up" ? (
            <p className='text-xs sm:text-sm text-center mt-4'>
              ...
              <a onClick={() => setState("login")} href='#' className='text-blue-700 hover:underline'>
                Login here
              </a>
            </p>
          ) : (
            <p className='text-xs sm:text-sm text-center mt-4'>
              create new account?{" "}
              <a onClick={() => setState("Sign Up")} href='#' className='text-blue-700 hover:underline'>
                Create here
              </a>
            </p>
          )}
